    ...
    public function store(Request $request)
{
    ...
    $validatedData = $request->validate([
        ...
        'other_service' => 'nullable|boolean', // This represents the checkbox
        'other_service_description' => 'nullable|string|max:255', // This is the description
    ]);
    ...
    return redirect()->route('applications')
     ...
     {
         $app = Application::with('service', 'status')->get();        
         $statuses = Status::all(); // Получаем все статусы
         return view('admin', compact('app', 'statuses'));
     }
     ...
     public function updateStatus(Request $request, $id)
        {
            ...
            return redirect()->route('admin')->with('success', 'Статус заявки успешно изменён!');
        }
